...
DROP TABLE IF EXISTS FORNECEDOR, FORNECEDOR_FORNECE_PRODUTO, ESTOQUE, PRODUTO_TEM_ESTOQUE, CLIENTE, COMPRA, PRODUTO, BAIRRO, FUNCIONARIO,
					 CAIXA, VENDEDOR, TELEFONE_FUNCIONARIO, TELEFONE_CLIENTE;
